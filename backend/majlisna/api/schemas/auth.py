...
from majlisna.api.constants import PASSWORD_MAX_LENGTH, PASSWORD_MIN_LENGTH
...
class TokenPairResponse(BaseModel):
    ...
    expires_in: int  # Access token lifetime in seconds — clients schedule refresh from this.
